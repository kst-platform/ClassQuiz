				...
				<div class="grid grid-cols-3 w-fit h-fit gap-4">
					...
					<div>
						...
						>
							...
							/>
							<span
								class="w-14 h-7 bg-gray-200 peer-focus:outline-hidden peer-focus:ring-4 peer-focus:ring-[#2F678C]/30 dark:peer-focus:ring-[#2F678C]/60 rounded-full peer dark:bg-gray-800 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[4px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all dark:border-gray-600 peer-checked:bg-[#2F678C]"
							></span>
						</label>
					</div>
					<div
